<template>
  <el-card class="category-group-card" shadow="hover">
    <!-- 卡片头部：分类信息 -->
    <div class="category-header">
      <div class="category-info">
        <el-icon :size="18" class="category-icon"><Folder /></el-icon>
        <span class="category-l1">{{ categoryL1Name }}</span>
        <el-icon :size="14" class="arrow-icon"><ArrowRight /></el-icon>
        <span class="category-l2">{{ categoryL2Name }}</span>
      ...
      >
        ...
        <div class="event-main">
          ...
          <div class="event-header">
            ...
            <span v-if="item.category_l3" class="category-l3-inline">
              <el-icon :size="12" class="arrow-icon"><ArrowRight /></el-icon>
              {{ item.category_l3.name }}
            </span>
