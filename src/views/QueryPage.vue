  ...
  <div class="query-page">
      ...
      <el-form :model="filters">
        ...
        <div class="filter-row">
          <el-form-item label="一级分类" class="filter-item">
            <el-select v-model="filters.category_l1_id" placeholder="全部" clearable style="width: 160px" @change="onL1FilterChange" @clear="onFilterChange">
          ...
          <el-form-item label="二级分类" class="filter-item" v-if="filters.category_l1_id">
            <el-select v-model="filters.category_l2_id" placeholder="全部" clearable style="width: 160px" @change="onL2FilterChange" @clear="onFilterChange">
          ...
          <el-form-item label="三级分类" class="filter-item" v-if="filters.category_l2_id">
            <el-select v-model="filters.category_l3_id" placeholder="全部" clearable style="width: 160px" @change="onFilterChange">
        ...
        <div class="filter-row">
          <el-form-item label="区域类型" class="filter-item">
            <el-select v-model="filters.region_type" placeholder="全部" clearable style="width: 120px" @change="onRegionTypeFilterChange" @clear="onFilterChange">
          ...
          <el-form-item label="具体区域" class="filter-item" v-if="filters.region_type">
            <el-select v-model="filters.region_id" placeholder="全部" clearable filterable style="width: 140px" @change="onFilterChange">
          ...
          <el-form-item label="关键词" class="filter-item">
            <el-input v-model="filters.keyword" placeholder="搜索备注、来源" clearable style="width: 200px" @change="onFilterChange" />
          </el-form-item>
    ...
    <el-card class="table-card">
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="区域" width="100" prop="region_name" show-overflow-tooltip />

        <el-table-column label="分类路径" width="220" prop="category_path" show-overflow-tooltip />
  ...
  try {
    ...
    let filtered = timePoints.filter(t => {
      ...
      if (filters.region_id) {
        if (t.region_id !== filters.region_id) return false
      } else if (filters.region_type) {
        const region = regionMap.get(t.region_id)
        if (!region || region.region_type !== filters.region_type) return false
      }
...
const onL1FilterChange = async () => {
  ...
  if (filters.category_l1_id) {
    filterLevel2Categories.value = await api.categories.getByParent(filters.category_l1_id)
  }
...
const onL2FilterChange = async () => {
  filters.category_l3_id = null
  filterLevel3Categories.value = []
  
  if (filters.category_l2_id) {
    filterLevel3Categories.value = await api.categories.getByParent(filters.category_l2_id)
  }
